...
public class Application {
    ...
    private static final MathContext _round = new MathContext(100000); //Number of decimals 
    ...
    public Application() {
        ...
        System.err.println(initP);
        CalcPI(initP, BigInteger.valueOf(4L));
    }

    public void CalcPI(BigDecimal P, BigInteger countRec) {
        this.recursiveLevel.add(BigInteger.ONE); //We are running this function
        ...
        System.err.println("¦ Recursive level count: " + recursiveLevel + " Lines: " + countRec + " Pi: " + pi.toString());
